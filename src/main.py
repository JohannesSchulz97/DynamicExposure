...
if __name__ == '__main__':
    ...
    p.add_argument('-a', '--algorithm', type = str, choices = ['Exp', 'NoExp'], default = 'Exp',
                   help = 'Inference method to use, among exposure(Exp) and no exposure(NoExp)'
                          'Default = "Exp"')
    p.add_argument('--file', type = str, default = 'data', help = 'file name')
    ...
    p.add_argument('--prep', default=0, type=int, help='tells you if preprocessing in form of taking the square root of the data should be applied')
